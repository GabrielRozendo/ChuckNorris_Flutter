...
class QuoteTile extends StatelessWidget {
  ...
  Widget _quoteMark(BuildContext context) => Positioned(
        child: Opacity(
          opacity: 0.7,
          child: Image.asset(
  ...
  Widget _share(BuildContext context) => Positioned(
  ...
  Widget _picture(BuildContext context) => Positioned(
  ...
  Widget _quoteText(BuildContext context) => Padding(
